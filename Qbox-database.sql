...
-- Dumping database structure for Qbox-database
CREATE DATABASE IF NOT EXISTS `Qbox-database` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `Qbox-database`;

-- Dumping structure for table Qbox-database.bank_accounts_new
...
-- Dumping structure for table Qbox-database.bans
...
-- Dumping structure for table Qbox-database.dealers
...
-- Dumping structure for table Qbox-database.lapraces
...
-- Dumping structure for table Qbox-database.management_outfits
...
-- Dumping structure for table Qbox-database.npwd_calls
...
-- Dumping structure for table Qbox-database.npwd_darkchat_channels
...
-- Dumping structure for table Qbox-database.npwd_darkchat_channel_members
...
-- Dumping structure for table Qbox-database.npwd_darkchat_messages
...
-- Dumping structure for table Qbox-database.npwd_marketplace_listings
...
-- Dumping structure for table Qbox-database.npwd_match_profiles
...
-- Dumping structure for table Qbox-database.npwd_match_views
...
-- Dumping structure for table Qbox-database.npwd_messages
...
-- Dumping structure for table Qbox-database.npwd_messages_conversations
...
-- Dumping structure for table Qbox-database.npwd_messages_participants
...
-- Dumping structure for table Qbox-database.npwd_notes
...
-- Dumping structure for table Qbox-database.npwd_phone_contacts
...
-- Dumping structure for table Qbox-database.npwd_phone_gallery
...
-- Dumping structure for table Qbox-database.npwd_twitter_likes
...
-- Dumping structure for table Qbox-database.npwd_twitter_profiles
...
-- Dumping structure for table Qbox-database.npwd_twitter_reports
...
-- Dumping structure for table Qbox-database.npwd_twitter_tweets
...
-- Dumping structure for table Qbox-database.occasion_vehicles
...
-- Dumping structure for table Qbox-database.ox_doorlock
...
-- Dumping structure for table Qbox-database.ox_inventory
...
-- Dumping structure for table Qbox-database.players
...
-- Dumping structure for table Qbox-database.playerskins
...
-- Dumping structure for table Qbox-database.player_groups
...
-- Dumping structure for table Qbox-database.player_jobs_activity
...
-- Dumping structure for table Qbox-database.player_mails
...
-- Dumping structure for table Qbox-database.player_outfits
...
-- Dumping structure for table Qbox-database.player_outfit_codes
...
-- Dumping structure for table Qbox-database.player_transactions
...
-- Dumping structure for table Qbox-database.player_vehicles
...
-- Dumping structure for table Qbox-database.properties
...
-- Dumping structure for table Qbox-database.properties_decorations
...
-- Dumping structure for table Qbox-database.users
...
-- Dumping structure for table Qbox-database.vehicle_financing
...
-- Dumping structure for table Qbox-database.weed_plants
...
-- Dumping structure for table Qbox-database.xt_prison
...
-- Dumping structure for table Qbox-database.xt_prison_items
